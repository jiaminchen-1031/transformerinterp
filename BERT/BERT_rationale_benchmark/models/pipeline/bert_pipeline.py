    ...
    * decode first the evidence, then run classification for each split
    ...
    if os.path.exists(epoch_save_file):
        ...
        method_folder = {"transformer_attribution": "transformer_attribution", "partial_lrp": "partial_lrp", "last_attn": "last_attn",
                         "attn_gradcam": "attn_gradcam", "rollout": "rollout", "generic_attribution":  "generic_attribution", "ours": "ours",
                         "ground_truth": "ground_truth", "generate_all": "generate_all", "ours_c":"ours_c"}
...
\end{document}
                ...
                if method in ["transformer_attribution", "partial_lrp", "attn_gradcam", "lrp", "generic_attribution", "ours", "ours_c"]:
