...
if __name__ == '__main__':
    ...
    newsgroups_train = fetch_20newsgroups(data_home='/root/datasets/', subset='all',remove=('headers', 'footers', 'quotes'))
    ...
    tokenizer = BertTokenizer.from_pretrained('/root/datasets/Pretrained_model/bert-base-uncased', do_lower_case=True)
    input_ids = []
    # For every sentence...
    for sent in sentences:
        ...
        encoded_sent = tokenizer.encode(
                            ...
                            max_length = 150,# Truncate all sentences.
    ...
    model = BertForSequenceClassification.from_pretrained(
        "/root/datasets/Pretrained_model/bert-base-uncased", # Use the 12-layer BERT model, with an uncased vocab.
